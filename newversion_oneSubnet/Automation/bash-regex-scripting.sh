# SINGLE server regex network IP extraction (example output: 10.11.12.143)
...
# COUNT number of words stored in a variable (example output: 6)
wc -w <<< $VAR
# alternative in case <<< is not supported: echo "$VAR" | wc -w
